...
import java.util.Calendar
    ...
    /**
     * Clase Oráculo para obtener las lecturas del futuro
     */
    class Oraculo(val dia: Int, val mes: Int) {
        // Signos del Zodiaco

        //creamos el array de signosZodiaco
        ...
        //llama a la funcion gerSignoZodiaco pasándole un dia y un mes
        //este codigo va en una clase aparte(clase oraculo)
        ...
        //funcion get signo zodiaco ,se introduce un día y un mes y devuelve un String
        ...
        // Función para obtener el día de la semana: el domingo es 1, lunes 2, ...etc
        private fun obtenerDiaDeLaSemana(): Int {
            val calendar = Calendar.getInstance()
            return calendar.get(Calendar.DAY_OF_WEEK)
        }

        // Método para obtener la posición del signo del Zodiaco
        ...
        /**
         * Método para obtener la predicción del Oráculo
         */
        fun obtenerPrediccion(nombre: String?): String {
            var prediccion: String = "Hola $nombre "
            val numDiaSemana = obtenerDiaDeLaSemana() - 1 // Recordad restar 1
            when (signo) {
